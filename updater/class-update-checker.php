<?php
if (!class_exists('GWSEPFSR_Update_Checker')) {

    class GWSEPFSR_Update_Checker {
        ...
        public function check_for_updates($transient) {
            ...
            $transient_name = 'epfsr_plugin_updates';
